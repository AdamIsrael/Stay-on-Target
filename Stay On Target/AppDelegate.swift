...
//  Stay On Target
//
//  Created by Adam @ Work on 2014-06-19.
//  Copyright (c) 2014 Adam Israel. All rights reserved.
//
...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    var applicationFilesDirectory: NSURL {
        // Returns the directory the application uses to store the Core Data store file. This code uses a directory named "com.Battleaxe.Stay_On_Target" in the user's Application Support directory.
        let fileManager = NSFileManager.defaultManager()
        let urls = fileManager.URLsForDirectory(.ApplicationSupportDirectory, inDomains: .UserDomainMask)
        let appSupportURL: AnyObject = urls[urls.endIndex - 1]
        return appSupportURL.URLByAppendingPathComponent("com.Battleaxe.Stay_On_Target")
    }
    ...
    var managedObjectModel: NSManagedObjectModel {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("Stay_On_Target", withExtension: "momd")
    ...
    var persistentStoreCoordinator: NSPersistentStoreCoordinator? {
        ...
        let url = applicationFilesDirectory.URLByAppendingPathComponent("Stay_On_Target.storedata")
